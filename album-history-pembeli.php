...
// Query the database for the album history for this buyer
$stmt = $pdo->prepare('SELECT * FROM album,pembeli WHERE id_pembeli = :id_pembeli ORDER BY kod_album DESC');
$stmt->execute(['id_pembeli' => $_SESSION['User_Id']]);
  ...
  <?php foreach ($products as $product): ?>
    <div class='product-item'>
      <form action='album-teliti-website.php' method='GET'>
        <button type='button' style='width: 200px; height: 200px; background-color: white; color: black; border:2px solid black;
        border-radius: 50px; display: flex; flex-direction: column; align-items: center;font-family: Arial,sans-serif;'>
